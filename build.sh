...
if [[ $DEPLOY_ENV = "mainnet" ]]; then
  ...
  flutter build web --web-renderer auto --release --no-sound-null-safety --pwa-strategy=none --dart-define=DEPLOY_ENV=staging --dart-define=FLUTTER_WEB_CANVASKIT_URL=/assets/canvaskit/
fi
