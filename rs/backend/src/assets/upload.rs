...
pub fn may_upload(caller: &ic_cdk::export::Principal, is_controller: bool, hex_sha256: &str, tarball_whitelist: &TarballWhitelist) -> Result<(), String> {
...
fn toy_whitelist() -> TarballWhitelist {
    TarballWhitelist {
        hashes: vec![TarballHash{commit: "caa36ce895eec16b6e59da586c3b5f6c55b9ac2a".to_string(), path: "out/assets-part1.tar.xz".to_string(), hash: "abba".to_string()}],
        operators: vec![ Principal::from_text("lanns-ouquq-hckhb-fgytd-vtn4m-rd5q4-hl3ct-vkwtm-ebcjo-xubks-kae").expect("Invalid principal in test setup") ],
    }
}
