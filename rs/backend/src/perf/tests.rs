...
#[test]
fn stats_stable_memory_serde_works() {
...
/// The performance counters are not critical to the operation of tghe canister and failing
/// to parse them should never ever cause a canister upgrade to fail.
#[test]
fn stats_stable_memory_never_fails() {
