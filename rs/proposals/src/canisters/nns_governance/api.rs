...
//! Candid for canister `nns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2026-02-20_12-29-hotfix-007c473c-retry-flaky-tests/rs/nns/governance/canister/governance.did>
#![allow(clippy::all)]
#![allow(missing_docs)]
...
pub struct SelfDescribingProposalAction {
    ...
    pub value: Option<Box<SelfDescribingValue>>,
}
#[derive(Serialize, CandidType, Deserialize)]
pub struct Proposal {
    pub url: String,
...
impl Service {
    ...
    pub async fn get_pending_proposals(
        &self,
        arg0: Option<GetPendingProposalsRequest>,
    ) -> CallResult<(Vec<ProposalInfo>,)> {
        ic_cdk::call(self.0, "get_pending_proposals", (arg0,)).await
    }
