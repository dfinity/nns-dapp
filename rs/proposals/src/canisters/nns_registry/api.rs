...
pub struct FirewallRule {
    ...
    pub ipv_4_prefixes: Vec<String>,
    pub direction: Option<i32>,
    pub action: i32,
    pub user: Option<String>,
    pub comment: String,
    #[serde(rename = "ipv6_prefixes")]
    pub ipv_6_prefixes: Vec<String>,
    pub ports: Vec<u32>,
}
#[derive(Serialize, CandidType, Deserialize)]
...
pub struct AddNodePayload {
    ...
    #[serde(rename = "public_ipv4_config")]
    pub public_ipv_4_config: Option<IPv4Config>,
    ...
    #[serde(rename = "p2p_flow_endpoints")]
    pub p_2_p_flow_endpoints: Vec<String>,
}
#[derive(Serialize, CandidType, Deserialize)]
...
#[derive(Serialize, CandidType, Deserialize)]
pub struct CreateSubnetResponseOk {
    pub new_subnet_id: Option<Principal>,
}
pub type CreateSubnetResponse = std::result::Result<CreateSubnetResponseOk, String>;
#[derive(Serialize, CandidType, Deserialize)]
...
pub type GetApiBoundaryNodeIdsResponse = std::result::Result<Vec<ApiBoundaryNodeIdRecord>, String>;
#[derive(Serialize, CandidType, Deserialize)]
pub struct GetChunkRequest {
    #[serde(rename = "content_sha256")]
    pub content_sha_256: Option<serde_bytes::ByteBuf>,
}
#[derive(Serialize, CandidType, Deserialize)]
pub struct Chunk {
    pub content: Option<serde_bytes::ByteBuf>,
}
pub type GetChunkResponse = std::result::Result<Chunk, String>;
#[derive(Serialize, CandidType, Deserialize)]
...
pub struct ReviseElectedGuestosVersionsPayload {
    ...
    #[serde(rename = "release_package_sha256_hex")]
    pub release_package_sha_256_hex: Option<String>,
}
#[derive(Serialize, CandidType, Deserialize)]
...
pub struct UpdateNodeIPv4ConfigDirectlyPayload {
    #[serde(rename = "ipv4_config")]
    pub ipv_4_config: Option<IPv4Config>,
    pub node_id: Principal,
}
...
pub struct UpdateNodeOperatorConfigPayload {
    ...
    #[serde(rename = "set_ipv6_to_none")]
    pub set_ipv_6_to_none: Option<bool>,
    #[serde(rename = "ipv6")]
    pub ipv_6: Option<String>,
