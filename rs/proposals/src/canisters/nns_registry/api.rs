...
//! Candid for canister `nns_registry` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-11-07_03-07-6.11-kernel/rs/registry/canister/canister/registry.did>
#![allow(clippy::all)]
#![allow(missing_docs)]
