...
mod def {
    ...
    pub type SetAuthorizedSubnetworkListArgs = crate::canisters::nns_cmc::internal::SetAuthorizedSubnetworkListArgs;
    ...
    pub struct RemoveNodeOperatorsPayloadHumanReadable {
        pub node_operators_to_remove: Vec<Principal>,
    }
        ...
        fn from(payload: RemoveNodeOperatorsPayload) -> Self {
            RemoveNodeOperatorsPayloadHumanReadable {
                node_operators_to_remove: payload
                    ...
                    .into_iter()
                    .map(|o| Principal::try_from(o).unwrap())
                    .collect(),
            }
        }
    }
    ...
    pub type UpdateSubnetTypeArgs = crate::canisters::nns_cmc::internal::UpdateSubnetTypeArgs;
    ...
    pub type ChangeSubnetTypeAssignmentArgs = crate::canisters::nns_cmc::internal::ChangeSubnetTypeAssignmentArgs;
    ...
    pub type BitcoinSetConfigProposal = crate::canisters::governance::internal::BitcoinSetConfigProposal;

    #[derive(CandidType, Serialize, Deserialize)]
    pub struct BitcoinSetConfigProposalHumanReadable {
        pub network: crate::canisters::governance::internal::BitcoinNetwork,
