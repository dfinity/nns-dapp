...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/2f5d582b29a95f06b96c8611950729e39b408eb6/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
