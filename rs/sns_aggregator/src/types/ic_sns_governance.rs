...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-12-04_03-28-base/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
