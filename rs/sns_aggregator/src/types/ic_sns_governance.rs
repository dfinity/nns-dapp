...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/f6458105cbcd0407e115dafecbc6311aa79a12f7/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
