...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-10-02_03-13-base/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
