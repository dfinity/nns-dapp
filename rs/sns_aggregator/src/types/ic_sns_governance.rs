...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-07-24_03-31-base/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
