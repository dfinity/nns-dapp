...
//! Candid for canister `sns_governance` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-08-07_03-33-base/rs/sns/governance/canister/governance.did>
#![allow(clippy::all)]
