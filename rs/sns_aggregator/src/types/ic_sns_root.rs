...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-09-19_10-17-base/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
...
/// ! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-08-28_03-17-snapshot-feature/rs/sns/root/canister/root.did>
#[derive(Serialize, Clone, Debug, CandidType, Deserialize)]
