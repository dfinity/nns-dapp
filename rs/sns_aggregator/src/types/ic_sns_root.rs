...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/rosetta-release-2.1.3/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
