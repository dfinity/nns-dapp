...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-12-06_03-16-sandboxes7k-secfix/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
