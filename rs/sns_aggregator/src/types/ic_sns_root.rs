...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-10-17_03-17-sev-prep/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
