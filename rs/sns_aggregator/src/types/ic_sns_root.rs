...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-07-25_21-03-base/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
