...
//! Candid for canister `sns_root` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/be2f9ca64c0af78da6925f50a9679c30420028ac/rs/sns/root/canister/root.did>
#![allow(clippy::all)]
