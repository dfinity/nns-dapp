...
//! Candid for canister `sns_swap` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/f54e1f82c3cf8ae0b4be6b0fc3a940cdcd70dd97/rs/sns/swap/canister/swap.did>
#![allow(clippy::all)]
#![allow(deprecated)]
...
pub type Result = std::result::Result<Ok, Err>;
#[derive(Serialize, Clone, Debug, CandidType, Deserialize)]
