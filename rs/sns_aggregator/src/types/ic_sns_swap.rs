...
//! Candid for canister `sns_swap` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-12-06_03-16-sandboxes7k-secfix/rs/sns/swap/canister/swap.did>
#![allow(clippy::all)]
