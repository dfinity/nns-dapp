...
//! Candid for canister `sns_swap` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/879597ef9a4bb1602ef2d140715f3cd50cca2420/rs/sns/swap/canister/swap.did>
#![allow(clippy::all)]
