...
//! Candid for canister `sns_swap` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-08-21_03-19-snapshot-feature/rs/sns/swap/canister/swap.did>
#![allow(clippy::all)]
