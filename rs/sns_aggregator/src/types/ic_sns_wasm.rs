...
//! Candid for canister `sns_wasm` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2023-10-25_23-01/rs/nns/sns-wasm/canister/sns-wasm.did>
#![allow(clippy::all)]
