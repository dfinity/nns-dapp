...
//! Candid for canister `sns_wasm` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/879597ef9a4bb1602ef2d140715f3cd50cca2420/rs/nns/sns-wasm/canister/sns-wasm.did>
#![allow(clippy::all)]
