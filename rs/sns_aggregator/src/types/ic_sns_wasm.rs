...
//! Candid for canister `sns_wasm` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-12-06_03-16-sandboxes7k-secfix/rs/nns/sns-wasm/canister/sns-wasm.did>
#![allow(clippy::all)]
