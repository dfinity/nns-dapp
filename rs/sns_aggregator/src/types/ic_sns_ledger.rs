...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/f6458105cbcd0407e115dafecbc6311aa79a12f7/rs/ledger_suite/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
