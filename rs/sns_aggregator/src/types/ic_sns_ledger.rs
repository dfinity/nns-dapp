...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-05-22_23-01-base/rs/rosetta-api/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
