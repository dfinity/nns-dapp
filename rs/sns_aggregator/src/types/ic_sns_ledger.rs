...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2026-02-05_03-47-base/rs/ledger_suite/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
