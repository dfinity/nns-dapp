...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2026-03-19_04-43-base/rs/ledger_suite/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
