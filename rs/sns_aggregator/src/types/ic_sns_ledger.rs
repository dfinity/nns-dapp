...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2024-12-06_03-16-sandboxes7k-secfix/rs/ledger_suite/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
