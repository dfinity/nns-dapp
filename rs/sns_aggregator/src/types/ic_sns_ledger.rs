...
//! Candid for canister `sns_ledger` obtained by `scripts/update_ic_commit` from: <https://raw.githubusercontent.com/dfinity/ic/release-2025-02-20_10-16-disable-best-effort-messaging/rs/ledger_suite/icrc1/ledger/ledger.did>
#![allow(clippy::all)]
