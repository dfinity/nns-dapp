...
const DfinityTextTheme = TextTheme(
    ...
    bodyText1: TextStyle(
            fontSize: 16, fontFamily: Fonts.circularBook, color: AppColors.gray100, fontWeight: FontWeight.normal),
    bodyText2: TextStyle(
            fontSize: 12, fontFamily: Fonts.circularBook, color: AppColors.gray100, fontWeight: FontWeight.normal),
    button: TextStyle(
