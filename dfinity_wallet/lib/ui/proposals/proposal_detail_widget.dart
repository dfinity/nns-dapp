        ...
        body: Container(
            ...
            child: StreamBuilder<Object>(
              ...
              builder: (context, snapshot) {
                final latestProposal = context.boxes.proposals.get(widget.proposal.id);
                return StreamBuilder(
                  stream: context.boxes.neurons.watch(),
                  builder: (context, snapshot) {
                    final updatedNeurons = context.boxes.neurons.values.toList();
                    return ConstrainWidthAndCenter(
                      ...
                      Column(
                        ...
                        children: [
                          ProposalStateCard(
                              proposal: latestProposal!, neurons: updatedNeurons
                          ),
                          CastVoteWidget(
                            proposal: latestProposal!, neurons: updatedNeurons,
                          ),
