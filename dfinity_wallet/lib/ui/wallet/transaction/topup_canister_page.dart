...
class TopUpCanisterPage extends StatefulWidget {
  ...
  const TopUpCanisterPage({Key? key, required this.wallet}) : super(key: key);
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text("Top up Canister", style: context.textTheme.headline2),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child:
                  Text("My Canister:", style: context.textTheme.headline3),
            ),
            Expanded(
                child: Column(
