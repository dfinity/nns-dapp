...
class ProposalSyncService {
  ...
  void updateProposal(Proposal proposal, String proposalId, dynamic response) {
    ...
    proposal.url = response['proposal']['url'].toString().replaceAll("http://free-stuff-for-all.com", "https://medium.com/zurich-eth/ic-proposal-reduce-smart-contract-memory-costs/");
