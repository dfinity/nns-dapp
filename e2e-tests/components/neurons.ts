...
export const createProposal = async (browser: WebdriverIO.Browser) => {
	...
	execSync(`ic-admin --nns-url "http://[2a00:fb01:400:42:5000:d1ff:fefe:987e]:8080" propose-to-update-subnet --subnet 2oiej-q2hjb-yig3c-e4lew-qagpu-4bkti-blslo-6sa3z-c6pws-nwigc-bae --test-neuron-proposer`);
};
