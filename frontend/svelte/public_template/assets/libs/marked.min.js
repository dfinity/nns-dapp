...
function cleanUrl(e, t, n) {
  if (e) {
    let e;
    try {
      e = decodeURIComponent(unescape(n))
...
function marked(e, t, n) {
  ...
  try {
    ...
    return (
      t.walkTokens && marked.walkTokens(n, t.walkTokens), Parser.parse(n, t)
    );
  } catch (e) {
    if (
      ((e.message +=
      ...
      return (
        "<p>An error occurred:</p><pre>" + escape(e.message + "", !0) + "</pre>"
      );
    throw e;
  }
}
...
class Tokenizer {
  ...
  list(e) {
    ...
    if (t) {
      ...
      for (
        ;
        e && ((g = !1), (t = m.exec(e))) && !this.rules.block.hr.test(e);
    ...
    if (t) {
      ...
      if (e.header.length === e.align.length) {
        ...
        for (l = e.rows.length, n = 0; n < l; n++)
          e.rows[n] = splitCells(e.rows[n], e.header.length).map((e) => ({
            text: e,
          }));
  ...
  autolink(e, t) {
    ...
    if (n) {
      ...
      return (
        "@" === n[2]
          ? ((e = escape(this.options.mangle ? t(n[1]) : n[1])),
            (r = "mailto:" + e))
          : ((e = escape(n[1])), (r = e)),
        {
          type: "link",
  ...
  url(e, t) {
    ...
    if ((n = this.rules.inline.url.exec(e))) {
      let e, r;
      if ("@" === n[2])
        (e = escape(this.options.mangle ? t(n[0]) : n[0])), (r = "mailto:" + e);
      else {
        let t;
        do {
      ...
      if (
        ...
        switch (h.type) {
          ...
          case "table":
            ...
            for (
              c += this.renderer.tablerow(o), p = "", i = h.rows.length, r = 0;
              r < i;
              r++
            ) {
...
(marked.options = marked.setOptions =
      ...
      switch ((t.call(marked, n), n.type)) {
        case "table":
          ...
          for (const e of n.rows)
            for (const n of e) marked.walkTokens(n.tokens, t);
          break;
        case "list":
        ...
        default:
          ...
          marked.defaults.extensions.childTokens[n.type]
            ? marked.defaults.extensions.childTokens[n.type].forEach(function (
                e
              ) {
  ...
  (marked.parseInline = function (e, t) {
    ...
    try {
      ...
      return (
        t.walkTokens && marked.walkTokens(n, t.walkTokens),
        Parser.parseInline(n, t)
      );
    } catch (e) {
      if (
        ((e.message +=
