  ...
  try {
    switch (nnsFunction) {
      ...
      case 4:
        return { 'Unable to display payload': 'Payload too large' };
      case 5:
        return IDL.decode([BlessReplicaVersionPayload], buffer)[0] as JsonObject;
      case 6:
      ...
      case 9:
        return { 'Unable to display payload': 'Payload too large' };
      case 10:
        return IDL.decode([UpdateIcpXdrConversionRatePayload], buffer)[0] as JsonObject;
      case 11:
        return IDL.decode([UpdateSubnetReplicaVersionPayload], buffer)[0] as JsonObject;
      case 12:
        return {};
      case 13:
        return IDL.decode([RemoveNodesFromSubnetPayload], buffer)[0] as JsonObject;
      case 14:
        return IDL.decode([SetAuthorizedSubnetworkListArgs], buffer)[0] as JsonObject;
      case 15:
        return IDL.decode([SetFirewallConfigPayload], buffer)[0] as JsonObject;
      case 16:
        return IDL.decode([UpdateNodeOperatorConfigPayload], buffer)[0] as JsonObject;
      case 17:
        return IDL.decode([StopOrStartNnsCanisterProposalPayload], buffer)[0] as JsonObject;
      case 18:
        return IDL.decode([RemoveNodesFromSubnetPayload], buffer)[0] as JsonObject;
      // case 19: return "Uninstall code from canister";
      case 20:
        return IDL.decode([UpdateNodeRewardsTableProposalPayload], buffer)[0] as JsonObject;
      case 21:
        return IDL.decode([AddOrRemoveDataCentersProposalPayload], buffer)[0] as JsonObject;
      case 22:
        return IDL.decode([UpdateUnassignedNodesConfigPayload], buffer)[0] as JsonObject;
      default:
        return null;
    }
  } catch (e) {
