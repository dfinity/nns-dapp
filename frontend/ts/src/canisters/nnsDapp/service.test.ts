...
describe("getTransactions", () => {
  test("respects the certified flag", () => {
    ...
    const dapp = new Service(uncertified, certified);
    expect(dapp.getTransactions(mock<GetTransactionsRequest>(), false)).resolves.toStrictEqual(uncertifiedResponse);
    expect(dapp.getTransactions(mock<GetTransactionsRequest>(), true)).resolves.toStrictEqual(certifiedResponse);
