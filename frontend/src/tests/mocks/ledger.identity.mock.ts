...
export class MockLedgerIdentity extends LedgerIdentity {
	constructor({ version }: MockIdentityOptions = {}) {
		...
		super(LEDGER_DEFAULT_DERIVE_PATH, Secp256k1PublicKey.fromRaw(fromHexString(rawPublicKeyHex)));
	...
	public static async create(options: MockIdentityOptions = {}): Promise<LedgerIdentity> {
