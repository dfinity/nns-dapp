...
export const principal = (index: number): Principal =>
	[
		Principal.fromText('2vtpp-r6lcd-cbfas-qbabv-wxrv5-lsrkj-c4dtb-6ets3-srlqe-xpuzf-vqe'),
		Principal.fromText('nv24n-kslcc-636yn-hazy3-t2zgj-fsrkg-2uhfm-vumlm-vqolw-6ciai-tae'),
		Principal.fromText('2lwez-knpss-xe26y-sqpx3-7m5ev-gbqwb-ogdk4-af53j-r7fed-k5df4-uqe'),
		Principal.fromText('vxi5c-ydsws-tmett-fndw6-7qwga-thtxc-epwtj-st3wy-jc464-muowb-eqe')
	][index];

export const createTransferableAmount = (amount: bigint): SnsTransferableAmount => ({
...
export const mockSnsSwapCommitment = (rootCanisterId: Principal): SnsSwapCommitment =>
	({
		[principal(0).toText()]: {
...
export const mockSwapCommitment = mockSnsSwapCommitment(principal(0)) as SnsSwapCommitment;
...
export const summaryForLifecycle = (lifecycle: SnsSwapLifecycle): SnsSummary => ({
