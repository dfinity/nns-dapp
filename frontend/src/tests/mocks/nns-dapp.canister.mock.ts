...
import { mockAccountDetails, mockMainAccount, mockSubAccountDetails } from './accounts.store.mock';
...
export class MockNNSDappCanister extends NNSDappCanister {
	...
	/* eslint-disable-next-line @typescript-eslint/no-unused-vars */
	public async createSubAccount(_: { subAccountName: string }): Promise<SubAccountDetails> {
