...
import type {CanisterDetailsModal, SelectCanisterDetailsStore} from "$lib/types/canister-detail.context";
...
export const mockToggleCanisterModal = (modal: CanisterDetailsModal | undefined) =>
