...
export const ledgerCanisterIdMock: Principal = Principal.fromText('ktxdj-qiaaa-aaaaa-aacqa-cai');

export const governanceCanisterIdMock: Principal = Principal.fromText(
	'ppmzm-3aaaa-aaaaa-aacpq-cai'
);

export const swapCanisterIdMock: Principal = Principal.fromText('kuwf5-5qaaa-aaaaa-aacqq-cai');
