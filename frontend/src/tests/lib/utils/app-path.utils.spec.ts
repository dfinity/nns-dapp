...
describe('routes', () => {
	...
	describe('getContextFromPath', () => {
		it('returns values after `/#/u` parent path', () => {
			...
			expect(getContextFromPath('/#/u/wxns6-qiaaa-aaaaa-aaaqa-cai/neurons')).toBe(
	...
	describe('getContextDetailsFromPath', () => {
		it('returns the rest of the path after the context', () => {
			...
			expect(getContextDetailsFromPath('/#/u/aaaaa-aa/neurons')).toBe('/neurons');
			expect(getContextDetailsFromPath('/#/u/aaaaa-aa/accounts')).toBe('/accounts');
			expect(getContextDetailsFromPath('/#/u/wxns6-qiaaa-aaaaa-aaaqa-cai/neurons')).toBe(
				'/neurons'
			);
