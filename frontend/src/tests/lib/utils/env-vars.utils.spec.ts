...
describe("env-vars-utils", () => {
  beforeEach(() => {
    ...
    vi.stubEnv(
      "VITE_FEATURE_FLAGS",
      '{\\"ENABLE_CKBTC\\":true,\\"ENABLE_CKTESTBTC\\":false,\\"ENABLE_ICP_ICRC\\":false,\\"ENABLE_ICP_INDEX\\":false,\\"ENABLE_SNS\\":true,\\"ENABLE_SNS_2\\":true,\\"ENABLE_VOTING_INDICATION\\":false}'
    );
