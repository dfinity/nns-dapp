...
import { mockSnsSummaryList, mockSnsSwapCommitment } from '../../mocks/sns-projects.mock';
...
describe('projects.store', () => {
	...
	describe('filter projects store', () => {
		...
		it('should filter projects that are active', () => {
			snsQueryStore.setData(snsResponsesForLifecycle({ lifecycles: [SnsSwapLifecycle.Open] }));
		...
		it('should filter projects that are committed only', () => {
			snsQueryStore.setData(snsResponsesForLifecycle({ lifecycles: [SnsSwapLifecycle.Committed] }));
