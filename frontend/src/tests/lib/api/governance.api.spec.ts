import { GovernanceCanister, ICPToken, LedgerCanister, TokenAmount, Topic } from '@dfinity/nns';
...
describe('neurons-api', () => {
	...
	beforeEach(() => {
		mockGovernanceCanister.listNeurons.mockImplementation(jest.fn().mockResolvedValue([]));
		mockGovernanceCanister.listKnownNeurons.mockImplementation(jest.fn().mockResolvedValue([]));
		mockGovernanceCanister.stakeNeuron.mockImplementation(jest.fn());
		mockGovernanceCanister.getNeuron.mockImplementation(jest.fn().mockResolvedValue(mockNeuron));
		jest.spyOn(GovernanceCanister, 'create').mockImplementation(() => mockGovernanceCanister);
	});
	...
	describe('disburse', () => {
		it('disburses neuron successfully', async () => {
			mockGovernanceCanister.disburse.mockImplementation(jest.fn().mockResolvedValue(undefined));
	...
	describe('addHotkey', () => {
		it('updates neuron successfully', async () => {
			mockGovernanceCanister.addHotkey.mockImplementation(jest.fn().mockResolvedValue(undefined));
