...
describe('HardwareWalletNeurons', () => {
	...
	it('should render text', () => {
		...
		expect(getByText(en.accounts.attach_hardware_neurons_text)).toBeInTheDocument();
	});
	...
	it('should render a neuron that has a hotkey', () => {
		...
		expect(getAllByText(en.accounts.attach_hardware_neurons_added)).toHaveLength(1);
	});
	...
	it('should render a neuron that has no hotkey', () => {
		...
		expect(getAllByText(en.accounts.attach_hardware_neurons_add)).toHaveLength(1);
	});
});
