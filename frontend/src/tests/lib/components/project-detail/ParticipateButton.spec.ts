...
describe('ParticipateButton', () => {
	...
	it('should render a text to increase participation', () => {
		...
		expect(queryByTestId('sns-project-participate-button')?.textContent ?? '').toEqual(
			en.sns_project_detail.increase_participation
		);
	});
	...
	it('should render a text to participate', () => {
		...
		expect(queryByTestId('sns-project-participate-button')?.textContent ?? '').toEqual(
			en.sns_project_detail.participate
		);
	});
	...
	it('should enable button is user has not committed max already', () => {
		...
		const button = queryByTestId('sns-project-participate-button') as HTMLButtonElement;
