...
describe('ProjectStatus', () => {
	...
	it('should render pending text when not yet open', () => {
		...
		expect(queryByText(en.sns_project_detail.status_pending)).toBeInTheDocument();
	});
	...
	it('should render unspecified text if not defined', () => {
		...
		expect(queryByText(en.sns_project_detail.status_unspecified)).toBeInTheDocument();
	});
	...
	it('should render committed text when not yet open', () => {
		...
		expect(queryByText(en.sns_project_detail.status_committed)).toBeInTheDocument();
	});
	...
	it('should render aborted text when cancelled', () => {
		...
		expect(queryByText(en.sns_project_detail.status_aborted)).toBeInTheDocument();
	});
});
