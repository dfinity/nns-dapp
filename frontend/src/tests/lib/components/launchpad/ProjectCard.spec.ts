...
describe('ProjectCard', () => {
	it('should render a logo', () => {
		...
		expect(img?.getAttribute('src')).toBe(mockSnsFullProject.summary.metadata.logo);
	});
	...
	it('should render a title', () => {
		...
		expect(
			getByText(`${en.sns_project.project} ${mockSnsFullProject.summary.metadata.name}`)
		).toBeInTheDocument();
	});
	...
	it('should render a description', () => {
		...
		expect(getByText(mockSnsFullProject.summary.metadata.description)).toBeInTheDocument();
	});
	...
	it('should render swap info', () => {
		...
		expect(getByText(en.sns_project_detail.user_current_commitment)).toBeInTheDocument();
	});
});
