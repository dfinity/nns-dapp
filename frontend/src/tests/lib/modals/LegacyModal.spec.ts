...
describe('LegacyModal', () => {
	...
	it('should render a backdrop', () => {
		...
		const backdrop: HTMLDivElement | null = container.querySelector('div.backdrop');
	...
	it('should render a wrapper', () => {
		...
		const wrapper: HTMLDivElement | null = container.querySelector('div.wrapper');
	...
	it('should render a toolbar', () => {
		...
		const toolbar: HTMLDivElement | null = container.querySelector('div.toolbar');
	...
	it('should render a content', () => {
		...
		const content: HTMLDivElement | null = container.querySelector('div.content');
	...
	it('should trigger close modal on click on close button', (done) => {
		...
		const button: HTMLButtonElement | null = container.querySelector('button[aria-label="Close"]');
	...
	it('should trigger back event on click on back button', (done) => {
		...
		const button: HTMLButtonElement | null = container.querySelector('button[aria-label="Back"]');
		button && fireEvent.click(button);
	});
});
