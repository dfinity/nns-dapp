...
const MAINNET_CKETH_MINTER_CANISTER_ID = "mqygn-kiaaa-aaaar-qaadq-cai";

// TODO: Add ckETHTEST canister IDs on env vars https://dfinity.atlassian.net/browse/GIX-2137
export const CKTESTETH_MINTER_CANISTER_ID = Principal.fromText(
  "ml52i-qqaaa-aaaar-qaaba-cai"
);

export const CKTESTETH_LEDGER_CANISTER_ID = Principal.fromText(
  "mc6ru-gyaaa-aaaar-qaaaq-cai"
);

export const CKTESTETH_INDEX_CANISTER_ID = Principal.fromText(
...
export const CKETH_MINTER_CANISTER_ID = Principal.fromText(
  envVars.ckbtcMinterCanisterId ?? MAINNET_CKETH_MINTER_CANISTER_ID
);

// Universes: the universe === the ledger canister ID
export const CKETH_UNIVERSE_CANISTER_ID = CKETH_LEDGER_CANISTER_ID;
export const CKETHTEST_UNIVERSE_CANISTER_ID = CKTESTETH_LEDGER_CANISTER_ID;
