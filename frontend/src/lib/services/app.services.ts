...
import { loadSnsSummariesProxy, loadSnsSwapCommitmentsProxy } from '../proxy/sns.services.proxy';
...
> => {
	const initNns: Promise<void>[] = [syncAccounts(), listNeurons(), loadMainTransactionFee()];
