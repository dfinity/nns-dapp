<script lang="ts">
	...
	import type { TransactionContext, TransactionStore } from '../../types/transaction.context';
	...
	export let onTransactionComplete: (() => Promise<void>) | undefined = undefined;
	export let validateTransaction: ((store: TransactionStore) => boolean) | undefined = undefined;
