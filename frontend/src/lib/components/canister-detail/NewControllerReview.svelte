...
<form on:submit|preventDefault={add} class="wizard-wrapper" data-tid="new-controller-review-screen">
	<div>
	...
	<FooterModal>
		<button class="secondary" type="button" on:click={() => dispatcher('nnsBack')}>
