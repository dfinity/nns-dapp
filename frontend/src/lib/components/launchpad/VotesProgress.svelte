...
<div class="latest-tally">
	<p>
		<span>{$i18n.proposal_detail.adopt}</span><span class="value">{formatNumber(yes)}</span>
	</p>
	<div
		class="progressbar"
		role="progressbar"
	...
	<p>
		<span>{$i18n.proposal_detail.reject}</span><span class="value">{formatNumber(no)}</span>
	</p>
</div>
