<script lang="ts">
	...
	import { ADD_ACCOUNT_CONTEXT_KEY, type AddAccountContext } from '../../types/add-account.context';
...
<form on:submit|preventDefault={onSubmit} class="wizard-wrapper">
	...
	{#if !disabled}
		<FooterModal>
			...
			<button class="primary" type="submit" {disabled} data-tid="ledger-attach-button">
