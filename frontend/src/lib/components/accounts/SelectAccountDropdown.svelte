<script lang="ts">
	...
	let selectedAccountIdentifier: string | undefined = selectedAccount?.identifier;
...
{#if selectableAccounts.length === 0}
	<Dropdown name="account" disabled selectedValue="no-accounts" testId="select-account-dropdown">
