<script lang="ts">
	...
	import { ENABLE_SNS, IS_TESTNET } from '../../constants/environment.constants';
	import BadgeNew from '../ui/BadgeNew.svelte';
	import GetICPs from '../ic/GetICPs.svelte';
	import { accountsPathStore, neuronsPathStore } from '../../derived/paths.derived';
			...
			? [
					{
						...
						selected: isSelectedPath([AppPath.Launchpad, AppPath.ProjectDetail]),
						label: 'launchpad',
