<script lang="ts">
	...
	import { canUserParticipateToSwap, hasUserParticipatedToSwap } from '../../utils/projects.utils';
...
{#if lifecycle === SnsSwapLifecycle.Open}
	{#if userCanParticipateToSwap}
		<button on:click={openModal} class="primary" data-tid="sns-project-participate-button"
