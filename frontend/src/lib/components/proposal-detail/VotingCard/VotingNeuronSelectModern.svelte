...
<Collapsible expandButton={false} externalToggle={true} bind:toggleContent bind:expanded wrapHeight>
	<div slot="header" class="total" class:expanded>
		...
		{#if displayNeuronsInfo}
			<div class="total-voting-power" data-tid="voting-collapsible-toolbar-voting-power">
