<script lang="ts">
	import { type ProposalInfo, type Vote, votableNeurons as getVotableNeurons } from '@dfinity/nns';
	...
	const { store } = getContext<SelectedProposalContext>(SELECTED_PROPOSAL_CONTEXT_KEY);
