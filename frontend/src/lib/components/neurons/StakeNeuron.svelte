<script lang="ts">
	...
	import { formattedTransactionFeeICP, getMaxTransactionAmount } from '../../utils/icp.utils';
	...
	const createNeuron = async () => {
		...
		startBusy({
			...
			labelKey: isHardwareWallet ? 'busy_screen.pending_approval_hw' : 'neurons.may_take_while'
		});
