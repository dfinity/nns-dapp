<script lang="ts">
	...
	import { startDissolving, stopDissolving } from '../../../services/neurons.services';
	...
	$: {
		...
		descriptionKey = isDissolving ? 'stop_dissolve_description' : 'start_dissolve_description';
	}
...
<button on:click={showModal} class="warning">{$i18n.neuron_detail[buttonKey]}</button>
{#if isOpen}
