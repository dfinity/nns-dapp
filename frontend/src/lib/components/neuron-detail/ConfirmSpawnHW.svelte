<script lang="ts">
	...
	import { formattedMaturity, isEnoughToStakeNeuron, neuronStake } from '../../utils/neuron.utils';
...
<div class="wrapper" data-tid="confirm-spawn-hw-screen">
	...
	<button data-tid="confirm-spawn-button" class="primary full-width" on:click={confirm} {disabled}>
