<script lang="ts">
	...
	import { hasMatchingProposals, lastProposalId } from '../utils/proposals.utils';
	import { proposalsFiltersStore, proposalsStore } from '../stores/proposals.store';
	import type { Unsubscriber } from 'svelte/types/runtime/store';
	import { debounce } from '../utils/utils';
	import { AppPath } from '../constants/routes.constants';
	import { listNextProposals, listProposals } from '../services/proposals.services';
	...
	import { sortedProposals, filteredProposals } from '../derived/proposals.derived';
	...
	const unsubscribe: Unsubscriber = proposalsFiltersStore.subscribe(({ lastAppliedFilter }) => {
	...
	$: initialized, loading, neuronsLoaded, $filteredProposals, (() => updateNothingFound())();
