...
class ICApiManager extends StatefulWidget {
  ...
  const ICApiManager({Key? key, required this.child, this.icApi})
      : super(key: key);
...
class ICApiManagerState extends State<ICApiManager> {
  ...
  Widget build(BuildContext context) {
    if (icApi == null) {
      ...
      return InternetComputerApiWidget(
        icApi: icApi!,
        child: widget.child,
      );
    }
...
class InternetComputerApiWidget extends InheritedWidget {
  ...
  InternetComputerApiWidget(
      {Key? key, required Widget child, required this.icApi})
      : super(key: key, child: child);

  static InternetComputerApiWidget of(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<InternetComputerApiWidget>()!;
  }
